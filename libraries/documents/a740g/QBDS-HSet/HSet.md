...
To use the `HSet` library, just place the command `$USELIBRARY:'a740g/QBDS-HSet'` at the top of your project.
...
To store **UDTs** in the set, you need to write wrapper **SUBs** around the low-level routines. These wrappers handle packing the UDT into a raw string buffer.
