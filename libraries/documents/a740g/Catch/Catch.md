...
To use the `Catch` library, just place the command `$USELIBRARY:'a740g/Catch'` at the top of your project.

```vb
' Optional: Force explicit variable declarations
DEFLNG A-Z
OPTION _EXPLICIT

' Mandatory: Console for test output, include library
$CONSOLE
$USELIBRARY:'a740g/Catch'

' Optional: Enables runtime error handling
...
The `TEST_ENABLE_ERROR_HANDLER` call enables runtime error handling and lets your test program exit cleanly if a runtime error occurs.
